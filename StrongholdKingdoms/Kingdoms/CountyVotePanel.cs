    ...
    public class CountyVotePanel : CustomSelfDrawPanel, IDockableControl
    {
        ...
        public void addPlayers()
        {
            ...
            if (this.countyMembers != null)
            {
                ...
                int position = 0;
                foreach (ParishMember member2 in this.countyMembers)
                {
        ...
        public void init(bool resized)
        {
            ...
            this.parishNameLabel.Text = GameEngine.Instance.World.getVillageName(this.m_currentVillage) + " (" + GameEngine.Instance.World.getCountyName(countyID) + ")";
            ...
            this.proclamationButton.CustomTooltipID = 0x1069;
            this.proclamationButton.Visible = false;
        ...
        Label_0CCD:
            ...
            if (!flag)
            {
                this.getCountyElectionInfoCallback(info.lastReturnData);
            }
        }
        ...
        {
            StoredCountyInfo info = (StoredCountyInfo) this.countyList[this.currentCounty];
            if (info != null)
            {
