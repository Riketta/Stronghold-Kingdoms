namespace Kingdoms
{
    ...
    public class BarracksPanel : CustomSelfDrawPanel, IDockableControl
    {
        ...
        public void init()
        {
            ...
            this.troop2Weapon1Image.Position = new Point(0x70, 0x7b);
            ...
            this.troop5Weapon1Image.Position = new Point(0x70, 0x7b);
            ...
            this.troopsMade6Disband.Position = new Point(0x392, 0x2e);
            ...
            this.troop6Image.Position = new Point(0x331, 12);
            this.mainBackgroundArea.addControl(this.troop6Image);
            this.troopGoldCost6Label.Text = "0";
            this.troopGoldCost6Label.Color = Color.FromArgb(0xd0, 0xa5, 0x66);
            this.troopGoldCost6Label.Position = new Point(0x45, 0xa5);
            this.troopGoldCost6Label.Size = new Size(0x2c, 0x2f);
            ...
            this.troopMake6Button5.Data = 0x44c;
            ...
            this.troopMake6Button20.Position = new Point(0x6c, y);
            ...
            this.troopMake6Button20.Data = 0x834;
            ...
            this.item1AmountLabel.Position = new Point(num2 - 3, 0x160);
            ...
            this.item2Image.Position = new Point(num2 + 0x4b, 310);
            ...
            this.item2AmountLabel.Position = new Point((num2 - 3) + 0x4b, 0x160);
            ...
            this.item3Image.Position = new Point(num2 + 150, 310);
            ...
            this.item3AmountLabel.Position = new Point((num2 - 3) + 150, 0x160);
            ...
            this.item4Image.Position = new Point(num2 + 0xe1, 310);
            ...
            this.item4AmountLabel.Position = new Point((num2 - 3) + 0xe1, 0x160);
            ...
            this.item5Image.Position = new Point(num2 + 300, 310);
            ...
            this.item5AmountLabel.Position = new Point((num2 - 3) + 300, 0x160);
            ...
            this.item6Image.Position = new Point(num2 + 0x177, 310);
            ...
            this.item6AmountLabel.Position = new Point((num2 - 3) + 0x177, 0x160);
            ...
            {
                this.CurrentTroopsLabel.Position = new Point(560, 0x16a);
            }
            else
            {
                this.CurrentTroopsLabel.Position = new Point(560, 0x165);
            }
            ...
            if (((Program.mySettings.LanguageIdent == "pl") || (Program.mySettings.LanguageIdent == "it")) || (Program.mySettings.LanguageIdent == "pt"))
            {
                this.SpaceLabel.Position = new Point(560, 0x149);
                this.SpaceLabel.Size = new Size(0x1a0, 20);
            }
            else
            {
                this.SpaceLabel.Position = new Point(560, 0x14e);
                this.SpaceLabel.Size = new Size(0xd8, 20);
            }
            ...
            {
                this.MaxLabelLabel.Position = new Point(700, 0x16a);
            }
            else if (Program.mySettings.LanguageIdent == "pl")
            {
                this.MaxLabelLabel.Position = new Point(770, 0x16a);
            }
            else
            {
            ...
            if (((Program.mySettings.LanguageIdent == "pl") || (Program.mySettings.LanguageIdent == "it")) || (Program.mySettings.LanguageIdent == "pt"))
            {
                this.fullBar.Position = new Point(770, 0x15d);
            }
            else
            {
            ...
            this.attackInfoButton.Position = new Point(0x361, (num3 + (2 * num4)) - 1);
            ...
            CustomSelfDrawPanel.WikiLinkControl.init(this.mainBackgroundArea, 5, new Point(0x382, 10));
        ...
        public void updateValues()
        {
            ...
            if ((village != null) && (castle != null))
            {
                ...
                int num6 = village.LocallyMade_Captains;
                int num7 = ((((num4 + num3) + num) + num5) + num2) + num6;
                VillageMap.ArmouryLevels levels = new VillageMap.ArmouryLevels();
                village.getArmouryLevels(levels);
                int num8 = ((int) levels.bowsLevel) - num2;
                int num9 = ((int) levels.pikesLevel) - num3;
                int num10 = ((int) levels.swordsLevel) - num4;
                int num11 = (((int) levels.armourLevel) - num3) - num4;
                int num12 = ((int) levels.catapultsLevel) - num5;
                this.item2AmountLabel.Text = num8.ToString("N", nFI);
                this.item4AmountLabel.Text = num9.ToString("N", nFI);
                this.item5AmountLabel.Text = num10.ToString("N", nFI);
                this.item3AmountLabel.Text = num11.ToString("N", nFI);
                this.item6AmountLabel.Text = num12.ToString("N", nFI);
                int num13 = village.m_spareWorkers - num7;
                this.item1AmountLabel.Text = num13.ToString("N", nFI);
                if ((num13 == 0) && (this.mouseOver >= 0))
                {
                ...
                int num14 = (int) GameEngine.Instance.World.getCurrentGold();
                num14 -= num * localWorldData.Barracks_GoldCost_Peasant;
                num14 -= num2 * localWorldData.Barracks_GoldCost_Archer;
                num14 -= num3 * localWorldData.Barracks_GoldCost_Pikeman;
                num14 -= num4 * localWorldData.Barracks_GoldCost_Swordsman;
                num14 -= num5 * localWorldData.Barracks_GoldCost_Catapult;
                int num15 = CardTypes.adjustTroopCost(GameEngine.Instance.World.UserCardData, localWorldData.Barracks_GoldCost_Peasant);
                int num16 = CardTypes.adjustTroopCost(GameEngine.Instance.World.UserCardData, localWorldData.Barracks_GoldCost_Archer);
                int num17 = CardTypes.adjustTroopCost(GameEngine.Instance.World.UserCardData, localWorldData.Barracks_GoldCost_Pikeman);
                int num18 = CardTypes.adjustTroopCost(GameEngine.Instance.World.UserCardData, localWorldData.Barracks_GoldCost_Swordsman);
                int num19 = CardTypes.adjustTroopCost(GameEngine.Instance.World.UserCardData, localWorldData.Barracks_GoldCost_Catapult);
                int num20 = localWorldData.CaptainGoldCost * GameEngine.Instance.World.getNumMadeCaptains();
                int numTroops = Math.Min(num13, num14 / num15);
                int num22 = Math.Min(Math.Min(num13, num14 / num16), num8);
                int num23 = Math.Min(Math.Min(Math.Min(num13, num14 / num17), num9), num11);
                int num24 = Math.Min(Math.Min(Math.Min(num13, num14 / num18), num10), num11);
                int num25 = Math.Min(Math.Min(num13, num14 / num19), num12);
                int num26 = Math.Min(num13, num14 / num20);
                if (num26 > 1)
                {
                    num26 = 1;
                }
                int num27 = village.calcTotalTroops() + num7;
                int num28 = village.calcUnitUsages() + num7;
                this.CurrentTroopsLabel.Text = SK.Text("BARRACKS_Troops", "Troops") + ": " + num27.ToString("N", nFI);
                int num29 = ResearchData.commandResearchTroopLevels[GameEngine.Instance.World.userResearchData.Research_Command];
                this.MaxLabelLabel.Text = SK.Text("BARRACKS_Max_Army_Size", "Max Army Size") + ": " + num29.ToString("N", nFI);
                int num30 = Math.Max(GameEngine.Instance.LocalWorldData.Village_UnitCapacity - num28, 0);
                this.SpaceLabel.Text = SK.Text("BARRACKS_Spare_Unit_Space", "Spare Unit Space") + ": " + num30.ToString("N", nFI);
                if (numTroops > num30)
                {
                    numTroops = num30;
                }
                ...
                int num31 = village.m_numCaptains + GameEngine.Instance.World.countYourArmyCaptains(village.VillageID);
                num31 += castle.countOwnPlacedCaptains();
                this.troopsMade6Disband.Text.Text = num31.ToString("N", nFI);
                bool flag = true;
                int num32 = ResearchData.captainsResearchCaptainsLevels[GameEngine.Instance.World.userResearchData.Research_Captains];
                if (num32 > 0)
                {
                    flag = true;
                    if (num31 >= num32)
                ...
                if ((num27 >= num29) || (num28 >= GameEngine.Instance.LocalWorldData.Village_UnitCapacity))
                {
                    numTroops = 0;
                    num22 = 0;
                    num23 = 0;
                ...
                this.makeArchers = num22;
                this.makePikemen = num23;
                this.makeSwordsmen = num24;
                this.makeCatapults = num25;
                this.makeCaptains = num26;
                ...
                int num33 = this.calcMidSize(numTroops);
                if (numTroops > 0)
                {
                    ...
                    if (numTroops >= num33)
                    {
                        this.troopMake1Button5.Text.Text = num33.ToString();
                ...
                else
                {
                    ...
                    if (num14 < localWorldData.Barracks_GoldCost_Peasant)
                    {
                        num34 |= 2;
                    }
                    if (num27 >= num29)
                    ...
                    if (num28 >= GameEngine.Instance.LocalWorldData.Village_UnitCapacity)
                    {
                        num34 |= 4;
                    }
                    this.troopMake1Button1.CustomTooltipID = 0xa8c;
                    this.troopMake1Button5.CustomTooltipID = 0xa8c;
                    this.troopMake1Button20.CustomTooltipID = 0xa8c;
                    this.troopMake1Button1.CustomTooltipData = num34;
                    this.troopMake1Button5.CustomTooltipData = num34;
                    this.troopMake1Button20.CustomTooltipData = num34;
                }
                ...
                int num35 = this.calcMidSize(num22);
                if (num22 > 0)
                {
                    ...
                    if (num22 >= num35)
                    {
                        this.troopMake2Button5.Text.Text = num35.ToString();
                        this.troopMake2Button5.Active = true;
                        this.troopMake2Button5.Text.Color = ARGBColors.Black;
                    }
                    if (num22 > 1)
                    {
                        this.troopMake2Button20.Text.Text = num22.ToString();
                ...
                else
                {
                    ...
                    if (num14 < localWorldData.Barracks_GoldCost_Archer)
                    {
                        num36 |= 2;
                    }
                    if (num27 >= num29)
                    ...
                    this.troopMake2Button1.CustomTooltipID = 0xa8c;
                    this.troopMake2Button5.CustomTooltipID = 0xa8c;
                    this.troopMake2Button20.CustomTooltipID = 0xa8c;
                    this.troopMake2Button1.CustomTooltipData = num36;
                    this.troopMake2Button5.CustomTooltipData = num36;
                    this.troopMake2Button20.CustomTooltipData = num36;
                }
                ...
                int num37 = this.calcMidSize(num23);
                if (num23 > 0)
                {
                    ...
                    if (num23 >= num37)
                    {
                        this.troopMake3Button5.Text.Text = num37.ToString();
                        this.troopMake3Button5.Active = true;
                        this.troopMake3Button5.Text.Color = ARGBColors.Black;
                    }
                    if (num23 > 1)
                    {
                        this.troopMake3Button20.Text.Text = num23.ToString();
                ...
                else
                {
                    ...
                    if (num14 < localWorldData.Barracks_GoldCost_Pikeman)
                    {
                        num38 |= 2;
                    }
                    if (num27 >= num29)
                    ...
                    this.troopMake3Button1.CustomTooltipID = 0xa8c;
                    this.troopMake3Button5.CustomTooltipID = 0xa8c;
                    this.troopMake3Button20.CustomTooltipID = 0xa8c;
                    this.troopMake3Button1.CustomTooltipData = num38;
                    this.troopMake3Button5.CustomTooltipData = num38;
                    this.troopMake3Button20.CustomTooltipData = num38;
                }
                ...
                int num39 = this.calcMidSize(num24);
                if (num24 > 0)
                {
                    ...
                    if (num24 >= num39)
                    {
                        this.troopMake4Button5.Text.Text = num39.ToString();
                        this.troopMake4Button5.Active = true;
                        this.troopMake4Button5.Text.Color = ARGBColors.Black;
                    }
                    if (num24 > 1)
                    {
                        this.troopMake4Button20.Text.Text = num24.ToString();
                ...
                else
                {
                    ...
                    if (num14 < localWorldData.Barracks_GoldCost_Swordsman)
                    {
                        num40 |= 2;
                    }
                    if (num27 >= num29)
                    ...
                    this.troopMake4Button1.CustomTooltipID = 0xa8c;
                    this.troopMake4Button5.CustomTooltipID = 0xa8c;
                    this.troopMake4Button20.CustomTooltipID = 0xa8c;
                    this.troopMake4Button1.CustomTooltipData = num40;
                    this.troopMake4Button5.CustomTooltipData = num40;
                    this.troopMake4Button20.CustomTooltipData = num40;
                }
                ...
                int num41 = this.calcMidSize(num25);
                if (num25 > 0)
                {
                    ...
                    if (num25 >= num41)
                    {
                        this.troopMake5Button5.Text.Text = num41.ToString();
                        this.troopMake5Button5.Active = true;
                        this.troopMake5Button5.Text.Color = ARGBColors.Black;
                    }
                    if (num25 > 1)
                    {
                        this.troopMake5Button20.Text.Text = num25.ToString();
                ...
                else
                {
                    ...
                    if (num14 < localWorldData.Barracks_GoldCost_Catapult)
                    {
                        num42 |= 2;
                    }
                    if (num27 >= num29)
                    ...
                    this.troopMake5Button1.CustomTooltipID = 0xa8c;
                    this.troopMake5Button5.CustomTooltipID = 0xa8c;
                    this.troopMake5Button20.CustomTooltipID = 0xa8c;
                    this.troopMake5Button1.CustomTooltipData = num42;
                    this.troopMake5Button5.CustomTooltipData = num42;
                    this.troopMake5Button20.CustomTooltipData = num42;
                }
                this.troopMake6Button1.invalidate();
                this.troopMake6Button1.Active = false;
                this.troopMake6Button1.Text.Color = Color.FromArgb(0x97, 0x86, 0x6c);
                this.troopMake6Button5.Active = false;
                this.troopMake6Button5.Text.Color = Color.FromArgb(0x97, 0x86, 0x6c);
                this.troopMake6Button20.Active = false;
                this.troopMake6Button20.Text.Color = Color.FromArgb(0x97, 0x86, 0x6c);
                int num43 = this.calcMidSize(num26);
                if (num26 > 0)
                {
                    ...
                    if (num26 >= num43)
                    {
                        this.troopMake6Button5.Text.Text = num43.ToString();
                        this.troopMake6Button5.Active = true;
                        this.troopMake6Button5.Text.Color = ARGBColors.Black;
                    }
                    if (num26 > 1)
                    {
                        this.troopMake6Button20.Text.Text = num26.ToString();
                ...
                else
                {
                    ...
                    this.troopMake6Button1.CustomTooltipID = 0xa8c;
                    this.troopMake6Button5.CustomTooltipID = 0xa8c;
                    this.troopMake6Button20.CustomTooltipID = 0xa8c;
                    this.troopMake6Button1.CustomTooltipData = num44;
                    this.troopMake6Button5.CustomTooltipData = num44;
                    this.troopMake6Button20.CustomTooltipData = num44;
                }
                int numPeasants = 0;
                int numArchers = 0;
                int numPikemen = 0;
                ...
                int num60 = 0;
                int num61 = 0;
                castle.countOwnPlacedTroopTypes(ref num57, ref num58, ref num59, ref num60, ref num61);
                this.inCastlePeasantsLabel.Text = num57.ToString("N", nFI);
                this.inCastleArchersLabel.Text = num58.ToString("N", nFI);
                this.inCastlePikmenLabel.Text = num59.ToString("N", nFI);
                this.inCastleSwordsmenLabel.Text = num60.ToString("N", nFI);
                this.inCastleCaptainsLabel.Text = num61.ToString("N", nFI);
                ...
                this.attackingCaptainsLabel.Text = numCaptains.ToString("N", nFI);
                ...
                this.reinforcingCaptainsLabel.Text = numReinfCaptains.ToString("N", nFI);
                ...
                numCaptains += village.m_numCaptains;
                numCaptains += num61;
                numCaptains += numReinfCaptains;
                ...
                int num62 = village.m_numPeasants + num;
                this.localPeasantsLabel.Text = num62.ToString("N", nFI);
                num62 = village.m_numArchers + num2;
                this.localArchersLabel.Text = num62.ToString("N", nFI);
                num62 = village.m_numPikemen + num3;
                this.localPikmenLabel.Text = num62.ToString("N", nFI);
                num62 = village.m_numSwordsmen + num4;
                this.localSwordsmenLabel.Text = num62.ToString("N", nFI);
                ...
                this.troopGoldCost1Label.Text = num15.ToString();
                this.troopGoldCost2Label.Text = num16.ToString();
                this.troopGoldCost3Label.Text = num17.ToString();
                this.troopGoldCost4Label.Text = num18.ToString();
                this.troopGoldCost5Label.Text = num19.ToString();
                this.troopGoldCost6Label.Text = num20.ToString();
                if (num14 < num15)
                {
                ...
                if (num14 < num20)
                {
                    this.troopGold6Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                else
                {
                    this.troopGold6Image.Colorise = ARGBColors.White;
                }
                if ((levels.bowsLevel == 0.0) && (this.mouseOver == 0x48))
                {
                    this.troop2Weapon1Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.item2Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                ...
                if ((levels.pikesLevel == 0.0) && (this.mouseOver == 0x49))
                {
                    this.troop3Weapon1Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.item4Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                ...
                if ((levels.swordsLevel == 0.0) && (this.mouseOver == 0x47))
                {
                    this.troop4Weapon1Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.item5Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                ...
                if ((levels.armourLevel == 0.0) && ((this.mouseOver == 0x49) || (this.mouseOver == 0x47)))
                {
                    this.troop3Weapon2Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.troop4Weapon2Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.item3Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                ...
                if ((levels.catapultsLevel == 0.0) && (this.mouseOver == 0x4a))
                {
                    this.troop5Weapon1Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                    this.item6Image.Colorise = Color.FromArgb(0xff, 0x80, 0x80);
                }
                ...
                if (num28 < GameEngine.Instance.LocalWorldData.Village_UnitCapacity)
                {
                    this.fullBar.Number = num28;
                }
                else
                {
                    this.fullBar.Number = GameEngine.Instance.LocalWorldData.Village_UnitCapacity;
                }
                if ((this.mouseOver >= 0) && ((GameEngine.Instance.LocalWorldData.Village_UnitCapacity - num28) <= 0))
                {
                ...
                this.troop1Image.CustomTooltipID = 0x25a;
                if (flag2)
                {
                    this.troop2Image.CustomTooltipID = 0x25b;
                ...
                {
                    this.troop2Image.CustomTooltipID = 0x260;
                ...
                if (flag5)
                {
                    this.troop5Image.CustomTooltipID = 0x25e;
                ...
                {
                    this.troop5Image.CustomTooltipID = 0x263;
                ...
                if (flag4)
                {
                    this.troop4Image.CustomTooltipID = 0x25d;
                ...
                if (flag3)
                {
                    this.troop3Image.CustomTooltipID = 0x25c;
                ...
                {
                    this.troop3Image.CustomTooltipID = 0x261;
                ...
                if (flag)
                {
                    this.troop6Image.CustomTooltipID = 0x25f;
                ...
                {
                    this.troop6Image.CustomTooltipID = 0x264;
